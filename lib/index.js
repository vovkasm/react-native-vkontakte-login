 ...
 * @hidden
 */
const VKLogin = react_native_1.NativeModules.VkontakteManager;
/**
 * @hidden
 */
const VKShare = react_native_1.NativeModules.VkontakteSharing;
var VKError;
(function (VKError) {
...
class VK {
    ...
    static share(options) {
        ...
        if (options.image) {
            nativeOptions.imageSource = react_native_1.Image.resolveAssetSource(options.image);
        }
